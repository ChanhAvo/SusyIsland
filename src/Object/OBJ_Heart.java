...
public class OBJ_Heart extends SuperObject {
    ...
    public OBJ_Heart(GamePanel gp) {
        ...
        name = "Heart";
        try (InputStream fileHeartFull = new FileInputStream("res/Objects/heart_full.png");
             InputStream fileHeartHalf = new FileInputStream("res/Objects/heart_half_full.png");
